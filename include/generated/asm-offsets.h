...
#define saved_context_gdt_desc 35 /* offsetof(struct saved_context, gdt_desc) */

#define TSS_entry2task_stack 3852 /* offsetof(struct cpu_entry_area, tss.x86_tss.sp1) - offsetofend(struct cpu_entry_area, entry_stack_page.stack) */

#define __NR_syscall_max 386 /* sizeof(syscalls) - 1 */
#define NR_syscalls 387 /* sizeof(syscalls) */

#define TASK_threadsp 924 /* offsetof(struct task_struct, thread.sp) */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags) */
#define TASK_addr_limit 988 /* offsetof(struct task_struct, thread.addr_limit) */
...
#define SIZEOF_entry_stack 256 /* sizeof(struct entry_stack) */
#define MASK_entry_stack -256 /* (~(sizeof(struct entry_stack) - 1)) */
